...
google_calendar_integration = st.sidebar.checkbox("Google Calendar Integration")

if google_calendar_integration:
    google_calendar_pipedream_url = st.sidebar.text_input("Google Calendar URL", 
        placeholder="Enter your Pipedream Google Calendar URL")
else:
    google_calendar_pipedream_url = None
...
if st.button("Generate Learning Path", type="primary", disabled=st.session_state.is_generating):
    ...
    elif google_calendar_integration and not google_calendar_pipedream_url:
        st.error("Please enter your Pipedream Google Calendar URL in the sidebar.")
    elif not user_goal:
